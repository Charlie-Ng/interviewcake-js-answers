...
// undefined: a variable that has not been defined or has been defined but not assigned values.

2. What are the differences between == and ===?
// == does type conversion and === is very straight about 'type'
// for example '0' == 0 is true but '0' === 0 is false

3. How would you compare two objects in JavaScript?
// say we obj1 and obj2
// we can simply do JSON.stringify(obj1) === JSON.stringify(obj2)
